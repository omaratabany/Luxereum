    ...
    marginBottom: "30px",
        ...
        <Grid container spacing={2} sx={{zIndex:100, }}>
            ...
            <Grid item xs={12} sm container>
                ...
                <Grid item>
                    <Button variant="outlined" sx={{color: 'black', boxShadow:"0px 4px 8px -2px black", marginBottom: "60px", borderColor: "black", backgroundColor:"whitesmoke", width:"200px", height:"41px", ':hover':{backgroundColor: "#333333", color:"white", borderColor:"black"}}}><DeleteIcon/>&nbsp;&nbsp;Remove</Button>
                </Grid>
            </Grid>
        </Grid>
    </Paper>
